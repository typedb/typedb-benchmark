...
import com.vaticle.typedb.benchmark.common.Config
import com.vaticle.typedb.benchmark.common.Context
import com.vaticle.typedb.benchmark.common.ModelParams
...
public class Runner : com.vaticle.typedb.simulation.Runner<ModelParams>() {
    ...
    override fun initSimulation(options: Options, config: Config): com.vaticle.typedb.simulation.Simulation<*, *> {
        ...
        return when (options.database) {
            Database.TYPEDB -> Benchmark(TypeDBClient.core(options.address, context.dbName), context).apply { init() }
