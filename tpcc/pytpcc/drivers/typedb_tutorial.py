...
# tag::db-schema-setup[]
def db_schema_setup(schema_session, schema_file='tql/iam-schema.tql'):
    script_dir = os.path.dirname(os.path.abspath(__file__))
    full_path = os.path.join(script_dir, schema_file)
...
def db_dataset_setup(data_session, data_file='tql/iam-data-single-query.tql'):
    script_dir = os.path.dirname(os.path.abspath(__file__))
