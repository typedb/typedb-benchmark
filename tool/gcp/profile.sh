...
DRIVER_VERSION_SHORT=${DRIVER_VERSION:0:4}
BENCH_ID=b-$USER-db$DB_SHORT-$DB_VERSION_SHORT-$DRIVER_VERSION_SHORT-$MACHINE_TYPE_SHORT-$DISK_SIZE-sf$SCALE_FACTOR-w$WAREHOUSES-c$CLIENTS-dur$DURATION-r$RUN_NUM
