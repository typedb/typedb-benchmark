...
public class Neo4jDriverWrapper implements DriverWrapper<Neo4jDriverWrapper.Session, Neo4jDriverWrapper.Transaction> {
    ...
    public static class Session extends DriverWrapper.Session<Session, Transaction> {
        ...
        @Override
        public Neo4jDriverWrapper.Transaction transaction() {
            return new Neo4jDriverWrapper.Transaction(session);
        }

    }

    public static class Transaction extends DriverWrapper.Transaction<Query, Result> {
