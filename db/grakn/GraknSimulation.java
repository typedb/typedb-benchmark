...
public class GraknSimulation extends Simulation<GraknContext> {

    private GraknContext graknContext;

    public GraknSimulation(String hostUri, String database, Map<String, Path> initialisationDataPaths, RandomSource randomSource, World world, List<Config.Agent> agentConfigs, Function<Integer, Boolean> iterationSamplingFunction, ResultHandler resultHandler) {
        super(hostUri, database, initialisationDataPaths, randomSource, world, agentConfigs, iterationSamplingFunction, resultHandler);
    }
