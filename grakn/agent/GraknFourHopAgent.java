...
public class GraknFourHopAgent extends FourHopAgent<GraknTransaction> {

    public GraknFourHopAgent(Client<?, GraknTransaction> client, SimulationContext context) {
        super(client, context);
    }

    @Override
    protected void matchFourHop(GraknTransaction tx) {
