...
public class GraknArbitraryOneHopAgent extends ArbitraryOneHopAgent<GraknTransaction> {

    public GraknArbitraryOneHopAgent(Client<?, GraknTransaction> client, SimulationContext context) {
        super(client, context);
    }

    @Override
    protected void matchArbitraryOneHop(GraknTransaction tx, String email) {
        tx.execute(match(
