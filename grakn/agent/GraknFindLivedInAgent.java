...
public class GraknFindLivedInAgent extends FindLivedInAgent<GraknTransaction> {

    public GraknFindLivedInAgent(Client<?, GraknTransaction> client, SimulationContext context) {
        super(client, context);
    }

    @Override
    protected void matchLivedIn(GraknTransaction tx) {
