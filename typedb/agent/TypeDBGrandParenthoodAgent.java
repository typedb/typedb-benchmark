...
import static com.vaticle.typedb.benchmark.typedb.Labels.GRANDCHILD;
import static com.vaticle.typedb.benchmark.typedb.Labels.GRANDPARENT;
import static com.vaticle.typedb.benchmark.typedb.Labels.GRANDPARENTHOOD;
...
public class TypeDBGrandParenthoodAgent extends GrandparenthoodAgent<TypeDBTransaction> {
    private static final String GP = "gp";

    public TypeDBGrandParenthoodAgent(Client<?, TypeDBTransaction> client, Context context) {
        super(client, context);
    }

    @Override
    protected void matchGrandparents(TypeDBTransaction tx, Country country, LocalDateTime birthDate) {
