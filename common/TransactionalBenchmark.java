...
public abstract class TransactionalBenchmark<DB_DRIVER extends TransactionalDbDriver<?, ?, DB_OPERATION>, DB_OPERATION extends TransactionalDbOperation> extends Benchmark<DB_DRIVER, DB_OPERATION> {

    public TransactionalBenchmark(DB_DRIVER driver, Map<String, Path> initialisationDataPaths, int randomSeed, World world, List<Config.Agent> agentConfigs, Function<Integer, Boolean> iterationSamplingFunction, boolean test) {
