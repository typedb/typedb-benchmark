...
def vaticle_typedb_client_java():
    git_repository(
        ...
        commit = "4f8f56b0bca0dfd436f3e49701c837123557c2cf",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_typedb_client_java
    )
