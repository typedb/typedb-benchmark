...
def vaticle_typedb_client_java():
    git_repository(
        ...
        commit = "5b8fdc9a8029628fae6299a8684d3c5548d436a1",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_typedb_client_java
    )
