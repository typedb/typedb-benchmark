...
def vaticle_typedb_client_java():
    git_repository(
        ...
        commit = "c2d0fd5b0d5e5629f8166b9a3bb5d9379d648da1",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_typedb_client_java
    )
