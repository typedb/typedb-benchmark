...
public abstract class MeanWageAgent<TX extends Transaction> extends Agent<GeoData.Global, TX> {

    public MeanWageAgent(Client<?, TX> client, SimulationContext context) {
    ...
    protected abstract void matchMeanWage(TX tx);
}
