...
public abstract class FindLivedInAgent<TX extends Transaction> extends Agent<GeoData.Global, TX> {

    public FindLivedInAgent(Client<?, TX> client, SimulationContext context) {
    ...
    protected abstract void matchLivedIn(TX tx);
}
