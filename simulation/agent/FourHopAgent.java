...
public abstract class FourHopAgent<TX extends Transaction> extends Agent<GeoData.Global, TX> {

    public FourHopAgent(Client<?, TX> client, SimulationContext context) {
    ...
    protected abstract void matchFourHop(TX tx);
}
