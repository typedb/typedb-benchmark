...
public abstract class LineageAgent<TX extends Transaction> extends Agent<Country, TX> {

    protected LineageAgent(Client<?, TX> client, Context context) {
        super(client, context);
    }

    @Override
    protected Class<? extends Agent> agentClass() {
        return LineageAgent.class;
    }
