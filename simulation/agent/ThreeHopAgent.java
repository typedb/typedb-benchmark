...
public abstract class ThreeHopAgent<TX extends Transaction> extends Agent<GeoData.Global, TX> {

    public ThreeHopAgent(Client<?, TX> client, SimulationContext context) {
    ...
    protected abstract void matchThreeHop(TX tx);
}
